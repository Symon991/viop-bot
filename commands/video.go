...
func (d VideoCommand) Execute() error {
	...
	parameters := []string{ytLinkString, "-f", "best[height<=720]", "--downloader-args", "ffmpeg_o:-f webm -vf scale=-1:480", "--download-sections", rangeString, "--force-keyframes-at-cuts", "-v", "-o", "-"}

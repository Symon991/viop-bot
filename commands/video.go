...
func (d VideoCommand) Execute() error {
	...
	parameters := []string{ytLinkString, "-f", "bv*[height<=720]+ba/b[height<=720]", "--downloader-args", "ffmpeg_o:-f webm", "--download-sections", rangeString, "--force-keyframes-at-cuts", "-v", "-o", "-"}
